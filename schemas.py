...
class Certification(BaseModel):
    certification: str = Field(
        description="The name of the certification and the organization or institution that issued the certification."
    )
...
class ProjectExperience(BaseModel):
    ...
    description: List[str] = Field(
        description="A list of all bullet points describing the projet experience,adhered to the original resueme context. Each bullet point should follow the authencity Ensure clarity, active voice, and impeccable grammar."
    )
...
class ResumeSchema(BaseModel):
    ...
    professional_experience: List[str] = Field(
        description="A brief pointwise summary of professional experience of candidate's career till date."
    )
    awards: List[str] = Field(
        description="job relevant key accomplishments, awards, or recognitions that demonstrate your skills and abilities."
    )
    ...
    project_experience: List[ProjectExperience] = Field(
